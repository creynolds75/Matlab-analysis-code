function [dt, durations, sleepState, steps, subjectID] = loadActiviteData(filename)
subjectID = regexprep(filename, 'activite_subject_', '');
subjectID = regexprep(subjectID, '.csv', '');
