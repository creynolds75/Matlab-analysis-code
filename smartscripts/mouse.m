% First, manually import subject Ids and start dates from Qualtrix spreadsheet
% Needs: mouseX, mouseY, timestamps, mouse click time stamps
% get OADC numbers from the database that are asscoiated with the su
...
for s = 1 : length(subjectIds);
    ...
    while lastpage == 0
        ...
        urltext=['https://juno.orcatech.org/php/healthforms/loadFormsUserInputBySubjIdSurveyIdYearMonth.php?s=' num2str(subjectId) '&ym=201612&p=' num2str(page) '&sv=8wEcKa486I0Jenj'];
